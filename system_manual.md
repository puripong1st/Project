...
* **ระบบความปลอดภัย:** บอร์ดจะต้องบังคับให้ Next.js ส่งหัวข้อ `X-API-Key` หรือ `Authorization` ที่กำหนดค่ารหัสผ่านร่วมกัน (เช่น `smartaccess_secure_door_unlock_token_2026`) เพื่อตรวจสอบสิทธิ์การปลดล็อก ป้องกันแฮกเกอร์แอบยิงไอพีเพื่อเปิดประตูเองโดยตรง
